...
- ✅ [MIGRATION_GUIDE.md](MIGRATION_GUIDE.md) - Detailed testing guide
...
- **[MIGRATION_GUIDE.md](MIGRATION_GUIDE.md)** - Complete testing guide with troubleshooting
...
3. **[MIGRATION_GUIDE.md](MIGRATION_GUIDE.md)** - Has detailed troubleshooting section
