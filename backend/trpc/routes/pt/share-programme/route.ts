...
export const shareProgrammeProcedure = protectedProcedure
  ...
  .mutation(async ({ ctx, input }) => {
    console.log("[PT] Sharing programme:", input.programmeId, "with client:", input.clientId);
    ...
    if (shareError) {
      console.error("[PT] Error sharing programme:", shareError);
      throw new TRPCError({
    ...
    console.log("[PT] Programme shared successfully:", sharedProgramme.id);
