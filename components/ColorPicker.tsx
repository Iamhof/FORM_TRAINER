...
// Normalization helper for color comparison
    ...
    <View style={styles.container}>
      ...
      >
        {PRESET_COLORS.map((color) => {
          const isSelected = normalizeForComparison(selectedColor) === normalizeForComparison(color.hex);
          
          return (
            <TouchableOpacity
              key={color.hex}
              style={styles.colorItemContainer}
              onPress={() => onColorSelect(color.hex.toUpperCase())}
              activeOpacity={0.7}
            >
              <View style={[
                styles.colorCircle,
