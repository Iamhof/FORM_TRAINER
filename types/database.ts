/**
 * Database types - These represent the actual database schema
 * Column names use snake_case to match PostgreSQL conventions
 * 
 * NOTE: Application code should use camelCase versions of these types.
 * The mapping between snake_case (DB) and camelCase (App) happens in:
 * - Frontend: contexts/UserContext.tsx
 * - Backend: trpc routes (e.g., routes/profile/update/route.ts)
 */
...
export interface ScheduleDay {
  ...
  sessionId?: string | null; // Session ID for scheduled workouts
  weekStart: string;
}
