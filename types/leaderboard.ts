...
/**
 * LeaderboardEntry - API response type
 * Uses camelCase for application layer consistency
 */
export interface LeaderboardEntry {
  ...
  accentColor?: string; // App field (camelCase) - Backend maps from accent_color
}
